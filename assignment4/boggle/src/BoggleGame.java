...
public class BoggleGame extends JFrame {
    ...
    private JList<String> validWordsList;
    private JList<String> opponentFoundWordsList;
    ...
    private void newGame() {
        ...
        if (gameDifficulty == NURSERY) {
            ...
            for (String word : validWords)
                if (shakespeareDictionary.contains(word) && StdRandom.uniformInt(3) != 0)
                    opponentFoundWords.add(word);
        }
    ...
    private void endGame() {
        ...
        validWordsList.setListData((String[]) validWords.toArray());
        ...
        foundWordsList.setListData((String[]) list1);
        ...
        opponentFoundWordsList.setListData((String[]) list2);
    ...
    private void checkWord() {
        ...
        if (validWords.contains(s) && !foundWords.contains(s)) {
            foundWords.add(s);
            foundWordsList.setListData((String[]) foundWords.toArray());
            points += scoreWord(s);
            scoreLabel.setText("Current Points: " + points);
            entryField.setText("");
        }
